...
const preferenceLabels = defineMessages({
  ...
  captionType3: {
    id: "preferences-screen.preference.caption-type-3",
    defaultMessage: "Caption Type 3"
  },
  captionType4: {
    id: "preferences-screen.preference.caption-type-4",
    defaultMessage: "Caption Type 4"
  },
  disableSoundEffects: {
